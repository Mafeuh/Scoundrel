...
var DECKS: Dictionary = {
	'normal': {
		'name': 'Normal',
		'cards': [
			'hearts:2', 'hearts:3', 'hearts:4', 'hearts:5', 'hearts:6', 'hearts:7', 'hearts:8', 'hearts:9', 'hearts:10',
			'clubs:A', 'clubs:2', 'clubs:3', 'clubs:4', 'clubs:5', 'clubs:6', 'clubs:7', 'clubs:8', 'clubs:9', 'clubs:10', 'clubs:J', 'clubs:Q', 'clubs:K',
			'diamonds:2', 'diamonds:3', 'diamonds:4', 'diamonds:5', 'diamonds:6', 'diamonds:7', 'diamonds:8', 'diamonds:9', 'diamonds:10', 
	...
	'test': {
		'name': 'Normal',
		'cards': [
			'bonus:2', 'hearts:10', 'hearts:Q', 'hearts:J',
		]
	},
}
